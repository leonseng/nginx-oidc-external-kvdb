export default { writeExtKVDB, readExtKVDB };
...
async function writeExtKVDB(r, key, value) {
...
async function readExtKVDB(r, key) {
  ...
  if (reply.status == 200) {
    var resp_body = JSON.parse(reply.responseBody);
