...
keyval_zone zone=oidc_id_tokens:1M state=/tmp/oidc_id_tokens.json timeout=1h;
keyval_zone zone=refresh_tokens:1M state=/tmp/refresh_tokens.json timeout=8h;
